...
func greeting(friend: String, me: String = "pupaw") {
...
greeting(to: "haha", from: "pupaw")


//MARK: - 가변 매개변수

//전달 받을 값을 개수를 알기 어려울 때 사용할 수 있음
//가변 매개변수는 함수 하나당 하나만 가질 수 있음
...
print(sayHelloToFriends(me: "pupaw", friends: "haha", "eric", "wing"))

print(sayHelloToFriends(me: "pupaw"))


/*
 위에서 설명한 함수의 다양한 모양들은 모두 섞어서 사용 가능
 */
